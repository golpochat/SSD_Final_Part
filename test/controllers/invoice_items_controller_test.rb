...
class InvoiceItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invoice_item" do
    assert_difference('InvoiceItem.count') do
      post invoice_items_url, params: { invoice_item: { amount: @invoice_item.amount, invoice_id: @invoice_item.invoice_id, item_id: @invoice_item.item_id, quantity: @invoice_item.quantity } }
    end
  ...
  test "should update invoice_item" do
    patch invoice_item_url(@invoice_item), params: { invoice_item: { amount: @invoice_item.amount, invoice_id: @invoice_item.invoice_id, item_id: @invoice_item.item_id, quantity: @invoice_item.quantity } }
